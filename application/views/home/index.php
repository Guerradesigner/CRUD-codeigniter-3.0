        ...
        <div class="content">
            <main>
                ...
                <section id="banner" class="display-flex flex-start block-sm text-left parallax" style="padding-top:-30px">
                    <div class="col-md-7 pd60 up_title">
                        ...
                        <br class="hidden-xs">
                        <h2 class="fz18 branco wow fadeInUp sub-title" data-wow-delay=".3s" data-wow-offset="0"><i class="glyphicon glyphicon-ok"></i> <strong>SEM BUROCRACIA,</strong><br><i class="glyphicon glyphicon-ok"></i> <strong>SEM COBRANÇA DE ROYALTIES, </strong><br>
...
<!--                            Formulário Mobile-->
                ...
                <section id="quem-somos" class="bg-neutro">
                    ...
                    <div class="row display-flex flex-reverse block-md">
                        ...
                        <div class="col-lg-6 z2 wow fadeInLeft">
                            <img src="<?= base_url('./assets/src/');?>images/img_quem_somos.jpg" alt="Produtos de qualidade que irão te levar ao sucesso!" title="Produtos de qualidade que irão te levar ao sucesso!" class="img-centro">
                        </div>
                    </div>
                ...
                <section id="franquias">
                  <div class="row p30">
                    <h2 class="titulo-principal wow fadeInUp">CONHEÇA O MÉTODO <strong style="color: #0c3157"><img src="<?= base_url('./assets/src/');?>images/logo-blue.png" alt="" width="200px"></strong></h2>
                    <br>
                    <div class="row">
                      <div class="col-lg-6"><img src="<?= base_url('./assets/src/');?>/images/home-servicos-back.jpg" alt="sofa-lavateria-cleanfor" class="img-responsive"></div>
                      <div class="col-lg-6">
                      <div class="panel panel-default">
                        <div class="panel-heading text-left  blue lighten-3 branco" role="tab" id="headingOne">
                            ...
                            <div class="panel panel-default">
                                ...
                                <h4 class="panel-title">
                                    <a class="collapsed fz20"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"><i class="fas fas fa-check "></i> Higienização</a>
                                </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <h4 class="panel-title">
                                    <a class="collapsed fz20"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseTwo"><i class="fas fas fa-check "></i> Impermeabilização</a>
                                </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <h4 class="panel-title">
                                    <a class="collapsed fz20"  role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFor" aria-expanded="true" aria-controls="collapseTwo"><i class="fas fas fa-check "></i> Hidratação</a>
                                </h4>
                                </div>
                    ...
                    <div class="row p30">
                      <h4>TRABALHOS OFERECIDOS:</h4>
                        ...
                        <div class="autoplay" data-slick='{"slidesToShow": 4, "slidesToScroll": 4}'>
                            <div class="card"><img src="<?= base_url('./assets/src/');?>images/servicos/tapete.png" width="100px"><h5><b>Carpetes</b></sup></h5></div>
                            <div class="card"><img src="<?= base_url('./assets/src/');?>images/servicos/assento.png" width="100px"><h5><b>Veículos</b></sup></h5></div>
                            <div class="card"><img src="<?= base_url('./assets/src/');?>images/servicos/sofa.png" width="100px"><h5><b>Estofados </b></sup></h5></div>
                            <div class="card"><img src="<?= base_url('./assets/src/');?>images/servicos/colchao.png" width="100px"><h5><b>Colchões</b></sup></h5></div>
                            <div class="card"><img src="<?= base_url('./assets/src/');?>images/servicos/cadeira.png" width="100px"><h5><b>Cadeiras</b></sup></h5></div>
                ...
                <section id="perfil">
                    ...
                    <div class="col-lg-5  wow fadeInUp ativo delay-1s" style="visibility: visible; animation-name: fadeInUp;"><img src="<?= base_url('./assets/src/');?>/images/page-image-servicos.jpg" alt="Clear For"  style="padding-top:7px;"class="img-responsive"></div>
                    <div class="col-lg-12 ">
                ...
                <section id="clientes"  class="branco">
                    <h2 class="titulo-principal wow bounceIn"><strong style="color: #fff">Clientes e parceiros</strong></h2>
                        ...
                        <div class="autoplay" data-slick='{"slidesToShow": 4, "slidesToScroll": 4}'>
                            <div><img src="<?= base_url('./assets/src/');?>images/clientes/clientes-Melissa_220_220.png"></div>
                            <div><img src="<?= base_url('./assets/src/');?>images/clientes/clientes-Banco-Bradesco_220_220.png"></div>
                            <div><img src="<?= base_url('./assets/src/');?>images/clientes/clientes-Banco-Santander_220_220.png"></div>
                            <div><img src="<?= base_url('./assets/src/');?>images/clientes/clientes-Shopping-Curitiba_220_220 (1).png"></div>
                            <div><img src="<?= base_url('./assets/src/');?>images/clientes/clientes-Shopping-Patio-Batel_220_220.png"></div>
                          
                        </div>
                        <div class="mt30 wow fadeInUp delay-1s">
                        <label for="check-form" class="botao-principal hidden-sm hidden-xs mb0 green darken-1 " title="Baixar nossa apresentação">Baixar Apresentação</label>
                        <a href="#mobile-form" class="botao-principal hidden-md hidden-lg m0 green darken-1" title="Baixar nossa apresentação">Baixar Apresentação</a>
                    </div>
                </section>
...
<div class="row"> 
            ...
            <aside class="side-form display-flex text-center hidden-xs hidden-sm">
                ...
                <div class="content">
                    <div>
                        <div class="etapa-form">
                            <h3 class="sub-titulo-principal menor fz22">Seja um franqueado de <b>SUCESSO</b><img src="<?= base_url('./assets/src/');?>images/logo-blue.png" alt="" width="200px"></h3>
        ...
        <script> var url = "<?= base_url('leads-cadastrar');?>
        "</script>
