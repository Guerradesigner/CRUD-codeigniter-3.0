                       ...
                       if(!isset($view['record'])){ 
                        ...
                        if(!isset($view['record'])){ 
                            ...
                            foreach ($areas as $key ){
                                ...
                                $options[$key['idAreas']] = $key['nome'];
     
                            }
                            select_options($nome = "areas", $alias ="Areas", $options, NULL, Null  );
                            ...
                            select_options($nome = "areas", $alias ="Areas", $options, NULL, $record = $view['record']['idAreas']  );
