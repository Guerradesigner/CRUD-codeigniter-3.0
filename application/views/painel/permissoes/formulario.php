                ...
                <div class="card-panel">
                    ...
                    <?php echo form_open('painel/'.TABELA_NOME.'/'. $view['action']['name'].'/'.$id); ?>
                       ...
                       if(!isset($view['record'])){ 
                        ...
                        $options = array(); 
                        foreach ($tabelas as $key ){
                            
                            $options[$key['idTabelas']] = $key['nome'];
 
                        }
                        select_options($nome = "tabelas", $alias ="Tabelas", $options, NULL, Null,);
                        ...
                        select_options($nome = "tabelas", $alias ="Tabelas", $options, NULL, $record = $view['record']['idTabela'], );
                       ...
                       if(!isset($view['record'])){ 
                        ...
                        foreach ($cargos as $key ){
                            ...
                            $options[$key['idCargos']] = $key['nome'];
 
                        }
                        select_options($nome = "cargos", $alias ="Cargos", $options, NULL, Null  );
                        ...
                        select_options($nome = "cargos", $alias ="Cargos", $options, NULL, $record = $view['record']['idCargos']  );
                        ...
                        if(!isset($view['record'])){ 
                            ...
                            foreach ($acao as $key ){
                                ...
                                $options[$key['idAcao']] = $key['nome'];
     
                            }
                            select_options($nome = "acao", $alias ="Acao", $options, NULL, Null  );
                            ...
                            select_options($nome = "acao", $alias ="Acao", $options, NULL, $record = $view['record']['idAcao']  );
                        ...
                        select_options($nome = "status", $alias ="Status", $options, NULL, NULL  );
                            ...
                            select_options($nome = "status", $alias ="Status", $options, NULL, $record = $view['record']['status']  );              
                        }
