...
class Tabelas_grupos extends CI_Controller {
    ...
    public function __construct() {
        ...
        define('TABELA_NOME', 'tabelas_grupos');
        define('TABELA_ALIAS', 'Tabelas Grupos');
        define('TABELA_ID', 'idTabelas_grupos');
    ...
    public function datatable() {
        ...
        $aColumns = array(TABELA_ID, 'nome', 'posicao', 'status');
