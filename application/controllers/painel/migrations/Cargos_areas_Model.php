...
class Cargos_areas_Model extends CI_Controller
{
  ...
  public function up()
  {
   ...
   helperconstruct_table_criar($user);
    ...
    helperconstruct_table_insert_fields( $user,'idAreas',' bigint','20',Null,Null);
    helperconstruct_table_insert_fields( $user,'idCargos','bigint','20',Null,Null);
