...
class Permissoes_Model extends CI_Controller
{
  ...
  public function up()
  {
   ...
   helperconstruct_table_criar($user);
    ...
    helperconstruct_table_insert_fields( $user,'idAcao','bigint','20',Null,Null);
    helperconstruct_table_insert_fields( $user,'idTabela','bigint','20',Null,Null);
